...
}})}(r,o)}},r._window.addEventListener("message",r._onMessage),"IFRAME"!==r.element.nodeName){var i=z(e,o);H(M(i),i,e).then(function(t){var n,o,i=G(t,e);return(// Overwrite element with the new iframe,
...
if(null!==e.getAttribute("data-vimeo-defer"))return;var t=z(e),r=M(t);H(r,t,e).then(function(t){return G(t,e)}).catch(n)}catch(e){n(e)}})}(),/**
...
//# sourceMappingURL=02-video.864de78a.js.map
